...
func (s *ServerRunOptions) Flags() (fss cliflag.NamedFlagSets) {
	...
	_ = fs.MarkDeprecated("ssh-user", "This flag will be removed in a future version.")

	// Deprecated in release 1.9
	fs.StringVar(&s.SSHKeyfile, "ssh-keyfile", s.SSHKeyfile,
		"If non-empty, use secure SSH proxy to the nodes, using this user keyfile")
	_ = fs.MarkDeprecated("ssh-keyfile", "This flag will be removed in a future version.")
	...
	_ = fs.MarkDeprecated("kubelet-port", "kubelet-port is deprecated and will be removed.")
	...
	_ = fs.MarkDeprecated("kubelet-read-only-port", "kubelet-read-only-port is deprecated and will be removed.")
